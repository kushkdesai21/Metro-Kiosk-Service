...
public class User_Table implements ActionListener {
	...
	String username;
	public void table_display(String usn) {
		username = usn;
		...
		detail.setText("Transactions of "+username);
		...
		frame.setVisible(true);
		 ...
		 try{
             ...
             String query= "select * from transaction where username='"+username+"'";
             Class.forName("com.mysql.cj.jdbc.Driver");
